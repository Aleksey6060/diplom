...
import { Shield, BookOpen, Users, GraduationCap, Settings, Inbox, FileText, MessageCircle, CreditCard, Image as ImageIcon } from 'lucide-react'
...
export default function AdminLayout() {
  ...
  if (isEmployee && canDecideAccess) {
    ...
    if (allowedSections.length > 0 && (!activeSeg || !allowedSet.has(activeSeg))) {
      return <Navigate to={allowedSections[0].to} replace />
    }
  }
  React.useEffect(() => {
